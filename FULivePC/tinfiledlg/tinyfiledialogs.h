...
CORE_EXPORT int tinyfd_messageBox (
...
CORE_EXPORT char const * tinyfd_inputBox (
	char const * const aTitle , /* "" */
	char const * const aMessage , /* "" may NOT contain \n \t on windows */
	char const * const aDefaultInput ) ;  /* "" , if NULL it's a passwordBox */
		/* returns NULL on cancel */

CORE_EXPORT char const * tinyfd_saveFileDialog (
	char const * const aTitle , /* "" */
...
CORE_EXPORT char const * tinyfd_openFileDialog (
	char const * const aTitle , /* "" */
	char const * const aDefaultPathAndFile , /* "" */
	int const aNumOfFilterPatterns , /* 0 */
	char const * const * const aFilterPatterns , /* NULL {"*.jpg","*.png"} */
...
CORE_EXPORT char const * tinyfd_selectFolderDialog (
	char const * const aTitle , /* "" */
	char const * const aDefaultPath ) ; /* "" */
		/* returns NULL on cancel */

CORE_EXPORT char const * tinyfd_colorChooser(
	char const * const aTitle , /* "" */
...
CORE_EXPORT int tinyfd_messageBoxW(
...
/* windows only - utf-16 version */
CORE_EXPORT wchar_t const * tinyfd_saveFileDialogW(
...
/* windows only - utf-16 version */
CORE_EXPORT wchar_t const * tinyfd_openFileDialogW(
	wchar_t const * const aTitle, /* "" */
...
/* windows only - utf-16 version */
CORE_EXPORT wchar_t const * tinyfd_selectFolderDialogW(
	wchar_t const * const aTitle, /* "" */
	wchar_t const * const aDefaultPath); /* "" */
		/* returns NULL on cancel */

/* windows only - utf-16 version */
CORE_EXPORT wchar_t const * tinyfd_colorChooserW(
	wchar_t const * const aTitle, /* "" */
