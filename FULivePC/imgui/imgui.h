...
namespace ImGui
{
    ...
    IMGUI_API bool          Button(const char* label, const ImVec2& size = ImVec2(0,0), int flag = 0);    // button
    ...
    IMGUI_API bool          ImageButtonHover(ImTextureID user_texture_id, ImTextureID user_texture_id2, const ImVec2& size, const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1), int frame_padding = -1, const ImVec4& bg_col = ImVec4(0, 0, 0, 0), const ImVec4& tint_col = ImVec4(1, 1, 1, 1));    // <0 frame_padding uses default frame padding settings. 0 for no padding
typedef enum {
	// 重置为默认状态
	ImGUI_Button_Operation_Type_Reset = -1,
	// 强制取消选中
	ImGUI_Button_Operation_Type_Deselect,
	// 强制选中
	ImGUI_Button_Operation_Type_Select,
}ImGUI_Button_Operation_Type;
	IMGUI_API bool          ImageRoundButton(ImGuiID& id,ImTextureID user_texture_id, const ImVec2& size, const ImVec2& uv0 = ImVec2(0, 0), const ImVec2& uv1 = ImVec2(1, 1), int frame_padding = -1, const ImVec4& bg_col = ImVec4(0, 0, 0, 0), const ImVec4& tint_col = ImVec4(1, 1, 1, 1),ImGUI_Button_Operation_Type button_operation_type = ImGUI_Button_Operation_Type_Deselect);    // <0 frame_padding uses default frame padding settings. 0 for no padding
	...
	IMGUI_API bool          SliderRoundScalar(const char* label, ImGuiDataType data_type, void* v, const void* v_min, const void* v_max, const char* format = NULL, float power = 1.0f);
	...
	IMGUI_API bool          SelectableBorder(const char* label, bool selected = false, ImGuiSelectableFlags flags = 0, const ImVec2& size = ImVec2(0, 0));  // "bool selected" carry the selection state (read-only). Selectable() is clicked is returns true so you can modify your selection state. size.x==0.0: use remaining width, size.x>0.0: specify width. size.y==0.0: use label height, size.y>0.0: specify height
