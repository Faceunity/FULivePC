...
const std::string g_tongue = "AI_model/tongue.bundle";
...
const std::string g_ai_bgseg_green = "AI_model/ai_bgseg_green.bundle";

const std::string g_ai_bgseg = "AI_model/ai_bgseg.bundle";
