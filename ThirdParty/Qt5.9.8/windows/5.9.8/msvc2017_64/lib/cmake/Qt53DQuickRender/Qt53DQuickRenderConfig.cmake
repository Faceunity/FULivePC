...
set(Qt53DQuickRender_VERSION_STRING 5.9.8)
...
if (NOT TARGET Qt5::3DQuickRender)
    ...
    set(Qt53DQuickRender_PRIVATE_INCLUDE_DIRS
        "${_qt53DQuickRender_install_prefix}/include/Qt3DQuickRender/5.9.8"
        "${_qt53DQuickRender_install_prefix}/include/Qt3DQuickRender/5.9.8/Qt3DQuickRender"
    )
    ...
    foreach(_module_dep ${_Qt53DQuickRender_MODULE_DEPENDENCIES})
        if (NOT Qt5${_module_dep}_FOUND)
            find_package(Qt5${_module_dep}
                5.9.8 ${_Qt53DQuickRender_FIND_VERSION_EXACT}
