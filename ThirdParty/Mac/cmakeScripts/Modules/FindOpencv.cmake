...
function(FindOpencv package)
	...
	if(${CMAKE_HOST_SYSTEM_PROCESSOR} MATCHES "x86_64")
	    set(${package}_LIBRARIES
			${${package}_HOME}/lib/x86_64/libopencv_core.3.4.dylib
			${${package}_HOME}/lib/x86_64/libopencv_highgui.3.4.dylib
			${${package}_HOME}/lib/x86_64/libopencv_imgcodecs.3.4.dylib
			${${package}_HOME}/lib/x86_64/libopencv_imgproc.3.4.dylib
			${${package}_HOME}/lib/x86_64/libopencv_video.3.4.dylib
			${${package}_HOME}/lib/x86_64/libopencv_videoio.3.4.dylib
		PARENT_SCOPE)
	 else()
		set(${package}_LIBRARIES
