...
更新内容
- 优化人脸检测，提高检测率，提高性能。 - 新增质感美颜功能（注：道具支持SDK v6.0.0以上版本）。 
...
- 修复mebedtls符号冲突问题。 
- 注：美发、Animoji道具支持FUEditor v5.6.0以上制作版本，其余道具在任意SDK皆可兼容  更新文档 - [美颜道具参数说明_完整版](docs/美颜道具参数说明_完整版.pdf) - [美妆bundle参数说明](docs/美妆bundle参数说明.pdf) - [质感美颜参数说明](docs/质感美颜参数说明.pdf) 
